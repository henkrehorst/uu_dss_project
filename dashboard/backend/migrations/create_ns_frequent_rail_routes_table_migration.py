...
def migrate():
    ...
    if not inspect(engine).has_table(table_name):
        ...
        Table(table_name, metadata,
              ...
              Column('from_station', String(length=10), nullable=False),
              Column('to_station', String(length=10), nullable=False),
              Column('to_code', String(length=10), nullable=False),
              Column('from_code', String(length=10), nullable=False),
